...
<body class="bg-dark text-light">
    ...
    <div class="container">
        ...
        <h2 class="text-center mt-5">Récapitulatifs des produits</h2>
        <?php
        if (!isset($_SESSION['products']) || empty($_SESSION['products'])) {
            echo "<p class='text-center'>Aucun produit en session...</p>";
        } else {
        ...
        <div class="d-flex justify-content-center">
            <a href="traitement.php?action=viderPanier" class="btn btn-danger w-50 p-2 mt-3">vider panier</a>
        </div>
        <!-- bouton annexe -->
